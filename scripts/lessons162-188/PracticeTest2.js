...
//для оптимальной работ компонентов
...
//значение возвращенное из raect.createContext то есть обьект контекста

//9 Допустимо ли создание нескольких useState и useEffect в одном компоненте?
//да даже приветсвуется разделение
...
//рендерить определенные компоненты в место которое находится вне dom
...
//то что функциии могут возвращать другие функции

//17 Хук useMemo позволяет мемоизировать...
//результат работы какой либо функции
...
//для соблюдения четкого порядка выполнения команд

//24 Каким образом можно выполнить отписку от эффектов при использовании хука useEffect?
//в конце функции вернуть еще одну функцию
